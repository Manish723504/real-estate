...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "a4cd67f6-0a21-49b1-8dad-2c225fe3a5f8");
  ...
  return (
    <motion.div
      ...
      <form on onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
          <div className='w-full md:w-1/2 text-left'>Your Name
            <input className='w-full border border-gray-300 rounded py-3
                        px-4 mt-2' type="text" name='Name' placeholder='Your Name' required /></div>

          <div className='w-full md:w-1/2 text-left md:pl-4'>Phone Number
            <input className='w-full border border-gray-300 rounded py-3
                        px-4 mt-2' type="text" name='Phone' placeholder='Your Phone Number' maxLength={10}  required /></div>
        </div>
